...
const albaQuestions = [
  ...
  "4.What's Sara’s favorite movie?",
  "5.What's her favorite season?",
  ...
  return (
    <div className="bg-white/90 p-6 rounded-xl shadow-lg max-w-xl w-95 h-80 relative">
      ...
      <h2 className="text-2xl font-bold mt-10 text-center">
        {winnerSelected ? 'Recompensa:' : isGameOver ? 'Final Round!' : `${currentPlayer}’s turn to guess!`}
      </h2>

      {/* Body */}
      <div className="text-center text-lg text-gray-800 mt-2 mb-4 min-h-[130px] flex items-center justify-center border border-gray-300">
        {winnerSelected ? (
